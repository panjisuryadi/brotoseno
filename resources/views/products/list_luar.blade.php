                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card border-0">
                        <div class="card-body p-0 d-flex align-items-center shadow-sm">
                            ...
                            <div>
                                <div class="text-value text-primary">{{ $formattedTotalBerat }}</div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card border-0">
                        <div class="card-body p-0 d-flex align-items-center shadow-sm">
                            ...
                            <div>
                                <div class="text-value text-warning">{{ $totalKuantitas }} Pcs</div>
                                <div class="text-muted text-uppercase font-weight-bold small">
                                    @lang('Total Quantity')
                                </div>
                            </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card border-0">
                        <div class="card-body p-0 d-flex align-items-center shadow-sm">
                            ...
                            <div>
                                <div class="text-value text-success">{{ $formattedTotalPembelian }}</div>
                                <div class="text-muted text-uppercase font-weight-bold small">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="flex justify-between pb-3 border-bottom">
                            <div>
                                <i class="bi bi-plus"></i> &nbsp; <span class="text-lg font-semibold"> List Produk Dari Luar
                                    (Tanpa Nota)</span>
                            </div>
                            <div id="buttons"></div>
                        </div>
