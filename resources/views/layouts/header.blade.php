...
<ul class="c-header-nav">
    <li class="c-header-nav-item px-3">
        <a class="c-header-nav-link text-success" href="{{ route('adjustments.index') }}" id="runningopname"
            style="display:none;">
...
<ul class="c-header-nav ml-auto mr-4">
    ...
    <?php
        ...
        if($status == 'A'){
        ?>
    <li class="c-header-nav-item mr-3 d-flex align-items-center" id="stock-opname-indicator"
        title="Stock Opname Status">
    ...
    @can('create_pos')
        <li class="c-header-nav-item mr-0">
            <a class="c-header-nav-link {{ request()->routeIs('sale.list') ? 'disabled' : '' }}" data-toggle="tooltip"
                data-placement="bottom" title="@lang('Hokkie POS')" href="{{ route('sale.list') }}">
    ...
    <li class="c-header-nav-item dropdown d-md-down-none">
        <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" title="@lang('Informasi Harga Emas')"
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg pt-0">
            ...
            <iframe
                src="https://harga-emas.org/widget/widget.php?v_widget_type=current_gold_price&v_height=260"></iframe>
        </div>
    </li>

    <li class="c-header-nav-item dropdown d-md-down-none">
        <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" title="@lang('Informasi Kurs hari ini')"
            aria-haspopup="true" aria-expanded="false">
    ...
    <li class="c-header-nav-item dropdown d-md-down-none mr-0">
        <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" title="@lang('Change language')"
            aria-haspopup="true" aria-expanded="false">
    ...
    <li class="c-header-nav-item dropdown">
        <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
            title="Informasi Akun" aria-expanded="false">
            <div class="c-avatar mr-2">

                {{-- <img class="w-7 h-7 c-avatar rounded-circle" src="{{ auth()->user()->getFirstMediaUrl('avatars') }}" alt="Profile Image"> --}}


                <img class="w-7 h-7 c-avatar rounded-circle" src="{{ asset('images/gtds.svg') }}"
                    alt="{{ auth()->user()->name }}">

            </div>
            <div class="d-flex flex-column">
                <span class="font-weight-bold py-0">{{ auth()->user()->name }}</span>
                <span style="font-size: 0.7rem !important;" class="online text-xs">Online <i
                        class="bi bi-circle-fill text-success" style="font-size: 0.7rem !important;"></i></span>
            </div>
        </a>
    ...
    {{-- <li class="c-header-nav-item dropdown d-md-down-none ml-1">
        <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" title="@lang('Hokkie Apps')"
            aria-haspopup="true" aria-expanded="false">
